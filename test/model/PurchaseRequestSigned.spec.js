...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheCoinBroker.PurchaseRequestSigned();
  });
  ...
  describe('PurchaseRequestSigned', function() {
    it('should create an instance of PurchaseRequestSigned', function() {
      // uncomment below and update the code to test PurchaseRequestSigned
      //var instane = new TheCoinBroker.PurchaseRequestSigned();
      //expect(instance).to.be.a(TheCoinBroker.PurchaseRequestSigned);
    });
