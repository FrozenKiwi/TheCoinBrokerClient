...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheCoinBroker.TapCapQueryRequestSigned();
  });
  ...
  describe('TapCapQueryRequestSigned', function() {
    it('should create an instance of TapCapQueryRequestSigned', function() {
      // uncomment below and update the code to test TapCapQueryRequestSigned
      //var instane = new TheCoinBroker.TapCapQueryRequestSigned();
      //expect(instance).to.be.a(TheCoinBroker.TapCapQueryRequestSigned);
    });
