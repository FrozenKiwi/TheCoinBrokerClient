...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheCoinBroker.SellRequestSigned();
  });
  ...
  describe('SellRequestSigned', function() {
    it('should create an instance of SellRequestSigned', function() {
      // uncomment below and update the code to test SellRequestSigned
      //var instane = new TheCoinBroker.SellRequestSigned();
      //expect(instance).to.be.a(TheCoinBroker.SellRequestSigned);
    });
