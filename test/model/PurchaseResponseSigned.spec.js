...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheCoinBroker.PurchaseResponseSigned();
  });
  ...
  describe('PurchaseResponseSigned', function() {
    it('should create an instance of PurchaseResponseSigned', function() {
      // uncomment below and update the code to test PurchaseResponseSigned
      //var instane = new TheCoinBroker.PurchaseResponseSigned();
      //expect(instance).to.be.a(TheCoinBroker.PurchaseResponseSigned);
    });
