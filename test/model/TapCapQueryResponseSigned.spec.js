...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheCoinBroker.TapCapQueryResponseSigned();
  });
  ...
  describe('TapCapQueryResponseSigned', function() {
    it('should create an instance of TapCapQueryResponseSigned', function() {
      // uncomment below and update the code to test TapCapQueryResponseSigned
      //var instane = new TheCoinBroker.TapCapQueryResponseSigned();
      //expect(instance).to.be.a(TheCoinBroker.TapCapQueryResponseSigned);
    });
