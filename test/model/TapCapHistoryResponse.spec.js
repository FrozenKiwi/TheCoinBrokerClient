...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheCoinBroker.TapCapHistoryResponse();
  });
  ...
  describe('TapCapHistoryResponse', function() {
    it('should create an instance of TapCapHistoryResponse', function() {
      ...
      //var instane = new TheCoinBroker.TapCapHistoryResponse();
      //expect(instance).to.be.a(TheCoinBroker.TapCapHistoryResponse);
    });
